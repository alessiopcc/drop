...
#if !defined(__forward__) && !defined(__src__bytewise__endianess__h)
#define __src__bytewise__endianess__h
...
namespace drop
{
    ...
    public:
        ...
        // Macros
                ...
                #define __src__bytewise__endianess__endianess big
            #endif

            #if __BYTE_ORDER == __LITTLE_ENDIAN
                #define __src__bytewise__endianess__endianess little
            #endif
        #endif
        ...
        static constexpr type local = __src__bytewise__endianess__endianess;
